...
import com.enuke.monitor.core.AndroidEvent;
import com.enuke.monitor.core.AndroidWatchdog;
import com.enuke.monitor.core.event.Watcher;
import com.enuke.monitor.observer.AndroidWatcher;
...
public final class AndroidWatchdogService extends Service {
	...
	public void onStart(final Intent intent, int startId) {
		...
		if (key != null) {
			...
			//System.out.println("exception when try to start watchdog");
		}
	}
